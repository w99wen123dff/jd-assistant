...
if __name__ == '__main__':
    ...
    sku_ids = '10024345293811'  # 商品id
    area = '2_2830_51810_0'  # 区域id
    asst = Assistant()  # 初始化
    asst.login_by_QRcode()  # 扫码登陆
    asst.buy_item_in_stock(sku_ids=sku_ids, area=area, wait_all=False, stock_interval=0.5, timerMode=False)  # 根据商品是否有货自动下单
    # 6个参数：
